      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <NavLink className="nav-link" activeClassName="active" to="/lregister">
              LRegister
            </NavLink>
            ...
            <NavLink className="nav-link" activeClassName="active" to="/bookrequests">
              Requested Books
            </NavLink>
            <NavLink className="nav-link" activeClassName="active" to="/borrowrecords">
              Borrow Records
            </NavLink>
